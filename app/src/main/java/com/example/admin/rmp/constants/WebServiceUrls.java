...
public class WebServiceUrls
{
    ...
    public static final String urlAddVitalInfo = HOST+ "index.php/api/v1_1/addVital";
    public static final String urlAddMedicalInfo = HOST + "index.php/api/v1_1/addMedicalcondition";
